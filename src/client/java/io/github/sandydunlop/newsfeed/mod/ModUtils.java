...
public class ModUtils {
    ...
    private static ModContainer getModContainer(@SuppressWarnings("rawtypes") Class cls) {
        ...
        List<EntrypointContainer<NewsfeedModInitializer>> epc = FabricLoader.getInstance().getEntrypointContainers("main",
                NewsfeedModInitializer.class);
        for (int i = 0; i < epc.size(); i++) {
            EntrypointContainer<NewsfeedModInitializer> entrypoint = epc.get(i);
